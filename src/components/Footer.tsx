    ...
    <div className="container mx-auto px-6">
        ...
        {[
          {
            ...
            links: [
              ...
              { label: "Video Rooms", to: "/video-rooms" },
              { label: "Fan Clubs", to: "/fan-clubs" },
            ],
          },
          {
            title: "Creators",
            links: [
              ...
              { label: "Wallet & Earnings", to: "/wallet" },
      ...
      <div className="mt-12 pt-8 border-t border-gold/10 text-center">
        <p className="font-body text-xs text-primary-foreground/30">
          © 2026 Qadrdaan. All rights reserved. Product of Solution Chief.
        </p>
      </div>
    </div>
  </footer>
